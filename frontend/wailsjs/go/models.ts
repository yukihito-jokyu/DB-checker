export namespace wails {
	...
	export class DeleteScenarioResponse {
	    scenarioId: string;
	    workspaceRemoved: boolean;

	    static createFrom(source: any = {}) {
	        return new DeleteScenarioResponse(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.scenarioId = source["scenarioId"];
	        this.workspaceRemoved = source["workspaceRemoved"];
	    }
	}
	...
	export class DeleteVerificationScenarioRequest {
	    scenarioId: string;
	    removeWorkspace: boolean;

	    static createFrom(source: any = {}) {
	        return new DeleteVerificationScenarioRequest(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.scenarioId = source["scenarioId"];
	        this.removeWorkspace = source["removeWorkspace"];
	    }
	}
	...
	export class PrepareVerificationRunRequest {
	    scenarioId: string;
	    runId: string;

	    static createFrom(source: any = {}) {
	        return new PrepareVerificationRunRequest(source);
	    }
	...
	export class Response_github_com_yukihito_jokyu_DB_checker_internal_handler_wails_DeleteScenarioResponse_ {
	    data?: DeleteScenarioResponse;
	    error?: ErrorResponse;

	    static createFrom(source: any = {}) {
	        return new Response_github_com_yukihito_jokyu_DB_checker_internal_handler_wails_DeleteScenarioResponse_(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.data = this.convertValues(source["data"], DeleteScenarioResponse);
	        this.error = this.convertValues(source["error"], ErrorResponse);
	    }
	...
	export class VerificationWorkspaceResponse {
	    scenarioId: string;
	    workspaceName: string;
	    mode: string;

	    static createFrom(source: any = {}) {
	        return new VerificationWorkspaceResponse(source);
	    }
	...
	export class Response_github_com_yukihito_jokyu_DB_checker_internal_handler_wails_VerificationWorkspaceResponse_ {
	    data?: VerificationWorkspaceResponse;
	    error?: ErrorResponse;

	    static createFrom(source: any = {}) {
	        return new Response_github_com_yukihito_jokyu_DB_checker_internal_handler_wails_VerificationWorkspaceResponse_(source);
	    }

	    constructor(source: any = {}) {
	        if ('string' === typeof source) source = JSON.parse(source);
	        this.data = this.convertValues(source["data"], VerificationWorkspaceResponse);
	        this.error = this.convertValues(source["error"], ErrorResponse);
	    }
	...
	export class UpdateVerificationRunStateRequest {
	    runId: string;
	    state: string;

	    static createFrom(source: any = {}) {
	        return new UpdateVerificationRunStateRequest(source);
	    }
