...
const (
	...
	CodeScenarioBusy                Code = "SCENARIO_BUSY"
	CodeVerificationNamespaceFailed Code = "VERIFICATION_NAMESPACE_FAILED"
...
var defaultMessages = map[Code]message{ // #nosec G101 -- 利用者向けエラーメッセージであり資格情報ではない。
	...
	CodeScenarioBusy:                "検証シナリオは使用中です",
	CodeVerificationNamespaceFailed: "検証用データベースの準備に失敗しました",
